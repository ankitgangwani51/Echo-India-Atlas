...
@date           27 Aug 2018
@description    Debt Recovery Instalment trigger implementation using the trigger handler framework
*******************************************************************************/
trigger GlUt_DebtRecoveyInstalmentTrigger on DebtRecoveryInstalment__c ( after delete, after insert, after undelete, after update, 
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJDEBTRECOVERYINSTALMENT;        // reference the trigger object here
