...
@date           21 June 2018
@description    Direct Credit Return  Trigger implementation using the trigger handler framework
*******************************************************************************/
trigger PyAp_DirectCreditReturnTrigger on DirectCreditReturn__c (
    ...
    before delete, before insert, before update) {
        ...
        trigObj.TriggerObject = GlUt_Constants.OBJDIRECTCREDITRETURNS;		// reference the trigger object here
