...
@date           20 Feb 2018
@description    Contract trigger implementation using the trigger handler framework
*******************************************************************************/
trigger GlUt_BillingContractTrigger on BillingContract__c (
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJCONTRACT;        // reference the trigger object here
