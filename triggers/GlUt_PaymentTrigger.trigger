/******************************************************************************
    ...
    @date           16 Jan 2018
    @description    Payment trigger implementation using the trigger handler 
                    framework
*******************************************************************************/
trigger GlUt_PaymentTrigger on Payment__c (after delete, after insert, after undelete, after update, 
    ...
    trigObj.triggerObject = GlUt_Constants.OBJ_PAYMENT;        // reference the trigger object here
