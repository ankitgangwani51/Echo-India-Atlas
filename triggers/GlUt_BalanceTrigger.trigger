...
@date           15 Feb 2018
@description    Balance trigger implementation using the trigger handler framework
*******************************************************************************/
trigger GlUt_BalanceTrigger on Balance__c (
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJ_BALANCE;		// reference the trigger object here
