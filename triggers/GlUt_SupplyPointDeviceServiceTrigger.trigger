...
@date          25-Oct-2017
@description:  Trigger for SupplyPointDeviceService object
Revision(s):   31-Oct-2017 -- Shivangi Gaur -- removed hardcoding from triggers.
**************************************************************************************************************/
trigger GlUt_SupplyPointDeviceServiceTrigger on SupplyPointDeviceService__c (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJSPDEVICESERVICE;
