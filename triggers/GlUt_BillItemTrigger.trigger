...
@date           06 Nov 2017
@description    Bill Item trigger implementation using the trigger handler framework
*******************************************************************************/
trigger GlUt_BillItemTrigger on BillItem__c (
    ...
    trigObj.triggerObject = GlUt_Constants.OBJ_BILLITEM;		// reference the trigger object here
