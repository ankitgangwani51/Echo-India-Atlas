/******************************************************************************
    ...
    @date           16 Jan 2018
    @description    Financial Control trigger implementation using the trigger handler 
                    framework
*******************************************************************************/
trigger GlUt_FinancialControlTrigger on FinancialControl__c (after delete, after insert, after undelete, after update, 
    ...
    trigObj.triggerObject = GlUt_Constants.OBJ_FINANCIALCONTROL;   // reference the trigger object here
