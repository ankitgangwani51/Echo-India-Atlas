...
@date          25-Oct-2017
@description:  Trigger for AvailableBundle object
**************************************************************************************************************/
trigger GlUt_AvailableBundleTrigger on AvailableBundle__c(after delete, after insert, after undelete, after update, before delete, before insert, before update) {
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJAVAILABLEBUNDLE;
