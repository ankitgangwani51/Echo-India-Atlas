/******************************************************************************
    ...
    @date           16 Jan 2018
    @description    Instalment trigger implementation using the trigger handler 
                    framework
*******************************************************************************/
trigger GlUt_InstalmentTrigger on Instalment__c (after delete, after insert, after undelete, after update, 
    ...
    trigObj.triggerObject = GlUt_Constants.OBJ_INSTALMENT;        // reference the trigger object here
