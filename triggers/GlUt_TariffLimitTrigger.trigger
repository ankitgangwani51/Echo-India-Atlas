...
@date          1-Aug-2018
@description:  Trigger for TariffLimit object
**************************************************************************************************************/
trigger GlUt_TariffLimitTrigger on TariffLimit__c (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJTARIFFLIMIT;
