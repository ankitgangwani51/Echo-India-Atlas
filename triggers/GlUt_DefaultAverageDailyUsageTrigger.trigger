trigger GlUt_DefaultAverageDailyUsageTrigger on DefaultAverageDailyUsage__c (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
    ...
    trigObj.TriggerObject = GlUt_Constants.OBJDADU;
