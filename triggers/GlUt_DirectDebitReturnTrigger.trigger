/******************************************************************************
    @author         Echo: Amit K.
    @date           20 June 2018
    @description    Direct Debit Return trigger implementation using the trigger handler framework
*******************************************************************************/
trigger GlUt_DirectDebitReturnTrigger on DirectDebitReturn__c (after delete, after insert, after undelete, after update, 
    ...
    trigObj.triggerObject = GlUt_Constants.OBJ_DIRECTDEBITRETURN;        // reference the trigger object here
