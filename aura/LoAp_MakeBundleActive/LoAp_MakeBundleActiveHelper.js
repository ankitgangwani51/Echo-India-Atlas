({
    ...
    doInit : function(component, event, helper){
        ...
        this.callServer(component, 'c.retrieveRecords',
                        function(response) { 
                           ...
                           component.set('v.recordToDisplay', response); 
                           component.set('v.availableBundleRecord' , component.get('v.recordToDisplay').objAvailableBundle); 
                           component.set('v.bundleRecord', component.get('v.recordToDisplay').objBundle);
    ...
    validateOnNext: function(component) {
        ...
        if (availableBundle[this.setPrefixedString('LastBundleChangeDate__c')]) {
            return true;
        }else{
    ...
    handleCallbackResponse : function(component, response) {
        ...
        if(response.getState() === 'SUCCESS') { 
            ...
            toastEvent.setParams({
                "type": "success",
                "message": $A.get('$Label.c.LoAp_ActivateBundleProcessing')
            });        
            toastEvent.fire();
    ...
    showNotification: function(component, message, type) {
        ...
        console.log('billCalcMessage= ' + billCalcMessage) ;
