({
    ...
    //Function called on value click of generate instalment or finish button
    doGenerateInstalments: function(component, event, helper) {		
        helper.clearNotification(component);
        component.set('v.saveValidation', false);
        helper.doGenerateInstalments(component, event, helper,'callFromGenerateButton');
    },
