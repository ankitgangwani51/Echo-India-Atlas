({
    ...
    doInit : function(component, event) {
        ...
        debugger;
        this.callServer(component, 'c.getScreenData',
                        function(response) {
                            component.set('v.tabFields', response.fieldPropertiesMap);
                            console.log('tabFields: ' + JSON.stringify(response));
                            component.set('v.fieldList', response.concessionExportFieldList); 
