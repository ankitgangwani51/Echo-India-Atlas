({
    doInit : function(component, event, helper) {
        ...
        var ReadingUploadFields = '[\'' + this.setPrefixedString('SerialNumber__c') + '\',\'' + this.setPrefixedString('ReadingDate__c')  + '\',\'' + this.setPrefixedString('Reading__c')  + '\',\'' + this.setPrefixedString('ReadingStatus__c')  + '\']';
        ...
        Map3.set(this.setPrefixedString('BatchRequestQueue__c'),$A.get("$Label.c.CuAp_ConcessionImportFieldSet"));
        component.set('v.mapBRQFieldSet',Map3);
    },
    
    showNewConcessionImport : function(component, event, helper) {       
        component.set("v.showNewConcessionImport", true);       
    }
