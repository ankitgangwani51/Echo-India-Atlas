({
	DEBUG: 'CuAp_AUManageServicesWizard: ',
    ...
    setWizardSteps: function(component) {
        ...
        */
        ...
        debugger;
        if(component.get('v.wizardType') != $A.get("$Label.c.CuAp_AddLabel")){
            remove(stepNames, $A.get("$Label.c.CuAp_ManageServices1"));
        }
    ...
    startProcessing: function(component, event, helper) {
        ...
        if(wizardprop.serviceTransfers)
                this.processingServices(component);                    
        else if(wizardprop.removedServices)
                this.removedServices(component);
    },
    
    processingServices: function(component) {
    ...
    //remove services
    removedServices: function(component) {
        component.find('spinner').show();
